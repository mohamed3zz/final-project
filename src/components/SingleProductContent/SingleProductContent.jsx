...
// export default function SingleProductContent({product_name, product_new_price, product_old_price, prouct_discription ,documentId }) {
...
//           addToCart({ product_name, product_new_price, documentId });
...
//           <Button  text={"Add to cart"} className='addtocart'  onClick={handleAddToCart} />
//           {messagedeleted && <p  style={{ color: "red" , fontSize:"1.2em" , fontWeight:"400", marginTop:"1em" }}>{messagedeleted}</p>}
//         </div>
//         : <div className='addtocartbox'>
//           <div className='addtocartup'>
//              <button className='button button-' onClick={DecreaseQuantity}>-</button>
//              <span>{quantity} <p>in cart</p></span>
//              <button className='button button+' onClick={IncreaseQuantity}>+</button>
//           </div>
